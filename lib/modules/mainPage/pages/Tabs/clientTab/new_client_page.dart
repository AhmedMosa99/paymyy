        ...
        children: [
          Container(
            margin: EdgeInsetsDirectional.only(start: 16.w),
              child: Text( "client_info".tr,style: AppTextStyles.b14.copyWith(color: AppColors.primary),)),
          buildFirstInformation(),
          Container(
              margin: EdgeInsetsDirectional.only(start: 16.w),
              child: Text(   "bank_details".tr,style: AppTextStyles.b14.copyWith(color: AppColors.primary),)),
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                PhoneFieldWidget(controller: mobile,horizontal: 16,),
                TextFieldWidget(
                  horozontal: 16,
                  validator: (value)=>InputValidations.validateEmail(value),

                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          leading: Text('سارة محمد الخالد',style: AppTextStyles.b12,),
                          trailing: Text('50.000 د.ك',style: AppTextStyles.r14.copyWith(color: AppColors.primary),),
                        ),
                         Container(
                             padding: EdgeInsets.symmetric(horizontal: 16.w),
                             child: Text('12\10\2022',style: AppTextStyles.r10.copyWith(color: Colors.black),)),
                        Divider(color: AppColors.grey87,),
                        ListTile
                          (
                          visualDensity: VisualDensity( vertical: -4),
                          leading: Text( "request_type".tr+' :',style: AppTextStyles.r14,),
                          title: Text('API',style: AppTextStyles.r12.copyWith(color: AppColors.grey87),),
                        ),
                        ListTile(
                          visualDensity: VisualDensity( vertical: -4),
                          leading: Text(  "request_state".tr+' :',style: AppTextStyles.r14,),
                          title: Text(  "not_excute".tr,style: AppTextStyles.r12.copyWith(color: AppColors.yellow1e),),
                        ),
                      ],
                    ),
                  ),
